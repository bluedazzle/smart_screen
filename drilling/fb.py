...
cur.execute('SELECT SHIFT_CONTROL_ID ,TANK_ID ,WATER_STICK ,CLOSE_QTY ,WATER_VOLUME ,TRANS_DATE FROM FUEL_TANK_READING WHERE TANK_ID = 1 ORDER BY TRANS_DATE DESC ROWS 2 TO 2')
res = cur.fetchall()[0]
